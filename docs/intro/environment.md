...
* KM+는 개인용 PC에서 작동하는 독립형(Stand‐alone) 소프트웨어입니다. 
...
:::note
 **Step 1** : 제공된 압축 파일을 다운로드합니다.\
 **Step 2** : 원하는 폴더에 압축을 해제합니다.\
 **Step 3** : 폴더 내 `KnowledgeMatrixPlus.exe` 실행 파일을 클릭하여 프로그램을 시작합니다.
:::
---
